...
public sealed class DatabaseInitializer(VertexDbContext db, IPasswordHasher<User> passwordHasher, IOptions<KubernetesOptions> kubernetesOptions, ILogger<DatabaseInitializer> logger)
{
    public async Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        logger.LogInformation("Seeded Vertex {Mode} workspace", kubernetesOptions.Value.Mode);
    }
}
